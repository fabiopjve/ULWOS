...
src/lcd_8x2.o: ../src/lcd_8x2.c
	@echo 'Scanning and building file: $<'
	@echo 'Invoking: Scanner and Compiler'
	@rl78-elf-gcc -MM -MP -MF "src/lcd_8x2.d" -MT"src/lcd_8x2.o" -MT"src/lcd_8x2.d" @"src/lcd_8x2.depsub" "$<"
	@echo	rl78-elf-gcc -MM -MP -MF "src/lcd_8x2.d" -MT"src/lcd_8x2.o" -MT"src/lcd_8x2.d" -x c   -nostdinc -ftree-loop-distribute-patterns -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mg13 -O2 -g2 -g -mmul=g13 "$<"
	@rl78-elf-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/lcd_8x2.sub" -o "$(@:%.d=%.o)" "$<"
	@echo rl78-elf-gcc -c -x c  -Wa,-adlhn="$(basename $(notdir $<)).lst" -nostdinc -ftree-loop-distribute-patterns -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mg13 -O2 -g2 -g -mmul=g13 -o "$(@:%.d=%.o)" "$<"
	@echo 'Finished scanning and building: $<'
	@echo.
